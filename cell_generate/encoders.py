"""
Adapted slightly from https://github.com/kenshohara/3D-ResNets-PyTorch/blob/master/models/resnet.py
"""
...
if __name__ == "__main__":
    inp = torch.rand((1, 2, 128, 128, 128)).cuda()
    model = generate_model(10, n_input_channels=2).cuda()
    out = model(inp)
    print(out.shape)
